...
public class Pengeluaran {
	...
	By btnPengeluaran = By.id("com.chad.financialrecord:id/btnExpense");
	By inputtvDate = By.id("com.chad.financialrecord:id/tvDate");
	By inputDate = By.xpath("//android.view.View[@content-desc=\"08 April 2022\"]");
	...
	public void addNewContact(String tvDate, String tvName, String Jumlah, String Keterangan) {
		...
		tunggu(1);
		driver.findElementByAccessibilityId("btnExpense").click();
		tunggu(1);
